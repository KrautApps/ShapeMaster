...
Class BBHttpRequest
	Method Open:Bool( req:String,url:String )
...
Class HttpRequest Implements IAsyncEventSource
	...
	Method Open:Bool( req:String,url:String,onComplete:IOnHttpRequestComplete )
		If _req And _req.IsRunning() Then Return False

		_req=New BBHttpRequest
		_onComplete=onComplete

		Return _req.Open( req,url )
	End
...
'		If _req.IsRunning() Error "HttpRequest in progress"
	...
	Method Send:Bool()
		If Not _req Then Return False
		If _req.IsRunning() Then Return False
	...
	Method Send:Bool( data:String,mimeType:String="text/plain;charset=UTF-8",encoding:String="utf8" )
		If Not _req Then Return False
		If _req.IsRunning() Then Return False
